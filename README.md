...
sh download_data.sh
```
Or you can download it from [here](https://drive.google.com/open?id=1X7oREQk4qE8z3po3vACZ4FKxPcWJF43A) and place it (after unzipping it) in the parent directory.
